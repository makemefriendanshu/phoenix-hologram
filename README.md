...
| 27 | Visual-only Admin Analytics dashboard (visited URLs, link clicks, unique IPs, visit log), linked from the site nav bar and `/admin` | ✅ Done — no request/visit-tracking backend exists yet; see [Pages](#pages) |
